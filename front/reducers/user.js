...
export const ADD_SCORE_TO_ME = "ADD_SCORE_TO_ME";
export const REMOVE_SCORE_OF_ME = "REMOVE_SCORE_OF_ME";
...
const reducer = (state = initialState, action) =>
  produce(state, (draft) => {
    switch (action.type) {
      ...
      //   },
      // };
      case ADD_SCORE_TO_ME:
        draft.me.Scores.unshift({ id: action.data });
        break;
      case REMOVE_SCORE_OF_ME:
